...
public final class MultiDexPluginManager {
    ...
    private static final String PLUGIN_DEX_FOLDER_NAME = "plugin_dexes_1";
...
//        }
        ...
        try {
            ...
            synchronized (installedApk) {
                ...
                File pluginDexPath = new File(applicationInfo.dataDir, PLUGIN_DEX_FOLDER_NAME);
                if (!pluginDexPath.exists()) {
                    pluginDexPath.mkdir();
                }
