...
//        }
    ...
    private static PluginPackageParser getPackageParserForComponent(Map<String, PluginPackageParser> pluginPackages,
            ComponentName componentName) {
        return pluginPackages.get(componentName.getPackageName());
    }
}
