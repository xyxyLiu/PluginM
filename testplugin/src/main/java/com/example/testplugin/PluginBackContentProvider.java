...
public class PluginBackContentProvider extends ContentProvider {

    private static final String TAG = "PluginBackProvider";
    public static final String AUTHORITY = "com.example.testplugin.testprovider.remote";
